 ...
 */
public class DoubleArrowPrimitive extends Node {
    ...
    private void buildArrow() {
        ...
        base.getMeshData().translatePoints(0, -cylinder_height/2.0-2.0*cone_height, 0);
        attachChild(base);
        ...
        tip.getMeshData().translatePoints(0, -cone_height/2.0-cone_height, 0);
        attachChild(tip);
        tip.updateModelBound();
        final Cone tip2 = new Cone("tip2", 4, 16, (float)cone_radius, (float)cone_height);
        tip2.getMeshData().rotatePoints(rotator);
        tip2.getMeshData().rotateNormals(rotator);
        tip2.getMeshData().translatePoints(0, -cone_height/2.0, 0);
        attachChild(tip2);
        tip2.updateModelBound();
    }
