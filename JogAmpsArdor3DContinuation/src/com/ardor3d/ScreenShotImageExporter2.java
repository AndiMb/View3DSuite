 ...
 */
public class ScreenShotImageExporter2 implements ScreenExportable {
    private static final Logger logger = Logger.getLogger(ScreenShotImageExporter2.class.getName());
     ...
     * @param filename
     *            the file name. This must be at least 3 characters long.
     * @param format
     ...
     */
    public ScreenShotImageExporter2(final File file, final String format,
    ...
    public void export(final ByteBuffer data, final int width, final int height) {
        ...
        try {
            logger.fine("Taking screenshot: " + _file.getAbsolutePath());

            // write out the screen shot image to a file.
            ImageIO.write(img, _fileFormat, _file);
