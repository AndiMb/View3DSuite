 ...
 * toolbars.
 *
 * Source: http://code.google.com/p/slyum/source/browse/src/utility/MultiBorderLayout.java?spec=svn5e9598927b626f0b26a08f801db5c12a9aaa16ea&r=5e9598927b626f0b26a08f801db5c12a9aaa16ea
 * 
...
public class MultiBorderLayout extends BorderLayout {
    ...
    private static final DimensionGetter getMinimumSize = (final Component in) -> in.getMinimumSize();

    private static final DimensionGetter getPreferredSize = (final Component in) -> in.getPreferredSize();

    private static final DimensionGetter getMaximumSize = (final Component in) -> in.getMaximumSize();
    ...
    public void layoutContainer(final Container target) {
        synchronized (target.getTreeLock()) {
            ...
            final Rectangle availableBounds = new Rectangle(
                    insets.left, insets.top, target.getWidth() - insets.left - insets.right, target.getHeight() - insets.top - insets.bottom
                    );
